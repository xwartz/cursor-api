...
export const ChatMessage: MessageFns<ChatMessage> = {
  encode(
    ...
    if (message.instructions !== undefined) {
      ChatMessage_Instructions.encode(
      ...
      switch (tag >>> 3) {
        case 2: {
          ...
          message.messages.push(
            ChatMessage_UserMessage.decode(reader, reader.uint32())
          )
          continue
        }
        case 4: {
          ...
          message.instructions = ChatMessage_Instructions.decode(
            reader,
            reader.uint32()
          )
          continue
  ...
  toJSON(message: ChatMessage): unknown {
    ...
    if (message.messages?.length) {
      obj.messages = message.messages.map(e =>
        ChatMessage_UserMessage.toJSON(e)
      )
    }
    if (message.instructions !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<ChatMessage>, I>>(
    ...
    const message = createBaseChatMessage()
    message.messages =
      object.messages?.map(e => ChatMessage_UserMessage.fromPartial(e)) || []
    message.instructions =
...
export const ChatMessage_FileContent: MessageFns<ChatMessage_FileContent> = {
  encode(
    message: ChatMessage_FileContent,
    writer: BinaryWriter = new BinaryWriter()
  ): BinaryWriter {
    if (message.filename !== '') {
    ...
    if (message.position !== undefined) {
      ChatMessage_FileContent_Position.encode(
        message.position,
    ...
    if (message.range !== undefined) {
      ChatMessage_FileContent_Range.encode(
        message.range,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.position = ChatMessage_FileContent_Position.decode(
            reader,
            reader.uint32()
          )
          continue
        ...
        case 6: {
          ...
          message.range = ChatMessage_FileContent_Range.decode(
            reader,
            reader.uint32()
          )
          continue
  ...
  fromJSON(object: any): ChatMessage_FileContent {
    return {
      ...
      position: isSet(object.position)
        ? ChatMessage_FileContent_Position.fromJSON(object.position)
        : undefined,
      language: isSet(object.language)
        ? globalThis.String(object.language)
        : '',
      range: isSet(object.range)
        ? ChatMessage_FileContent_Range.fromJSON(object.range)
        : undefined,
  ...
  create<I extends Exact<DeepPartial<ChatMessage_FileContent>, I>>(
    base?: I
  ): ChatMessage_FileContent {
    return ChatMessage_FileContent.fromPartial(base ?? ({} as any))
  },
  fromPartial<I extends Exact<DeepPartial<ChatMessage_FileContent>, I>>(
    object: I
  ): ChatMessage_FileContent {
    const message = createBaseChatMessage_FileContent()
...
export const ChatMessage_FileContent_Position: MessageFns<ChatMessage_FileContent_Position> =
  {
    encode(
      message: ChatMessage_FileContent_Position,
      writer: BinaryWriter = new BinaryWriter()
    ): BinaryWriter {
      if (message.line !== 0) {
    ...
    fromPartial<
      I extends Exact<DeepPartial<ChatMessage_FileContent_Position>, I>,
    >(object: I): ChatMessage_FileContent_Position {
      const message = createBaseChatMessage_FileContent_Position()
...
export const ChatMessage_FileContent_Range: MessageFns<ChatMessage_FileContent_Range> =
  {
    encode(
      message: ChatMessage_FileContent_Range,
      writer: BinaryWriter = new BinaryWriter()
    ): BinaryWriter {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          case 1: {
            ...
            message.start = ChatMessage_FileContent_Position.decode(
              reader,
              reader.uint32()
            )
            continue
          ...
          case 2: {
            ...
            message.end = ChatMessage_FileContent_Position.decode(
              reader,
              reader.uint32()
            )
            continue
    ...
    fromJSON(object: any): ChatMessage_FileContent_Range {
      return {
        start: isSet(object.start)
          ? ChatMessage_FileContent_Position.fromJSON(object.start)
          : undefined,
        end: isSet(object.end)
          ? ChatMessage_FileContent_Position.fromJSON(object.end)
          : undefined,
      }
    },
    ...
    create<I extends Exact<DeepPartial<ChatMessage_FileContent_Range>, I>>(
      base?: I
    ): ChatMessage_FileContent_Range {
...
export const ChatMessage_UserMessage: MessageFns<ChatMessage_UserMessage> = {
  encode(
    message: ChatMessage_UserMessage,
    writer: BinaryWriter = new BinaryWriter()
  ): BinaryWriter {
    if (message.content !== '') {
  ...
  create<I extends Exact<DeepPartial<ChatMessage_UserMessage>, I>>(
    base?: I
  ): ChatMessage_UserMessage {
    return ChatMessage_UserMessage.fromPartial(base ?? ({} as any))
  },
  fromPartial<I extends Exact<DeepPartial<ChatMessage_UserMessage>, I>>(
    object: I
  ): ChatMessage_UserMessage {
    const message = createBaseChatMessage_UserMessage()
    message.content = object.content ?? ''
...
export const ChatMessage_Instructions: MessageFns<ChatMessage_Instructions> = {
  encode(
    message: ChatMessage_Instructions,
    writer: BinaryWriter = new BinaryWriter()
  ): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<ChatMessage_Instructions>, I>>(
    base?: I
  ): ChatMessage_Instructions {
    return ChatMessage_Instructions.fromPartial(base ?? ({} as any))
  },
  fromPartial<I extends Exact<DeepPartial<ChatMessage_Instructions>, I>>(
    object: I
  ): ChatMessage_Instructions {
    const message = createBaseChatMessage_Instructions()
...
export const ChatMessage_Model: MessageFns<ChatMessage_Model> = {
  ...
  create<I extends Exact<DeepPartial<ChatMessage_Model>, I>>(
    base?: I
  ): ChatMessage_Model {
    return ChatMessage_Model.fromPartial(base ?? ({} as any))
  },
  fromPartial<I extends Exact<DeepPartial<ChatMessage_Model>, I>>(
    object: I
  ): ChatMessage_Model {
    const message = createBaseChatMessage_Model()
...
export const ResMessage: MessageFns<ResMessage> = {
  ...
  fromPartial<I extends Exact<DeepPartial<ResMessage>, I>>(
    object: I
  ): ResMessage {
    const message = createBaseResMessage()
